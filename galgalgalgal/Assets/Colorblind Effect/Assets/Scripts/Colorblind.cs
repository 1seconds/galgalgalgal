...
namespace Wilberforce
{
  ...
  //          }
		//}
		public void SetScreenEffect(bool isNormal)
        {
        ...
        void Start()
        {
            ...
            if (colorblindShader == null) colorblindShader = Shader.Find("Hidden/Colorblind");
           ...
           // Type=(int)GameManager.instance.dataManager.colorBlind;
            isSupported = true;
        }
